...
const atThePark: ProblemSet = {
  theme: "At the Park",
  passage:
    "You have one minute to prepare.This is a story about a woman who wanted to promote better organization at public events.You have two minutes to narrate the story.Your story should begin with the following sentence:“One day, a young woman was on her way to a local festival.”",
  questions: [
    {
      id: 1,
      question: "Please look at the fourth picture. If you were the woman, what would you be thinking? "
    },
    {
      id: 2,
      question: "Should more be done to warn people, about potential hazards at public events?"
    },
    {
      id: 3,
      question: "Should festival organizers do more to keep the event safe for everyone, especially children?”"
    },
    {
      id: 4,
      question: "Do you think public opinion influences government decisions?"
    },
