...
import { sampleQuestions, passageText } from '../../constants/1/questions1';
...
const ExamQuestionCard: React.FC = () => {
  ...
  const [countdown, setCountdown] = useState(60);          // 20秒黙読カウントダウン
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      playTTS(" Choose one of the topics and think about the content of your speech. You have one minute to think about it.");
  ...
  useEffect(() => {
    if (countdown > 0 && showCard) {
      ...
      playTTS("Please begin your speech.");
    }
  }, [countdown, showCard]);
  ...
  if (examFinished) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.header}>1級評価結果</Text>
        <ScrollView
  ...
  if (showCard) {
    return (
      <View style={styles.container}>
        ...
        <NeomorphBox width={320} height={600} forceTheme={'light'}>
        <Text style={styles.passageTitle}>英文パッセージ</Text>
        {/* 各選択肢 */}
          <Text style={styles.choiceText}>
          1  Should governments limit the use of social media to protect public safety?
          </Text>
          <Text style={styles.choiceText}>
          2  Is it better to live in a big city or a small town?
          </Text>
          <Text style={styles.choiceText}>
          3  Does technology make people’s lives easier or more complicated?
          </Text>
          <Text style={styles.choiceText}>
          4  Should schools focus more on creativity rather than memorization?
          </Text>
        {/* 選択された英文を表示 */}
    ...
    return (
      <View style={styles.container}>
        ...
        <NeomorphBox width={320} height={320} forceTheme={'light'}>
          <Text style={styles.passageText}>Please begin your speech.</Text>
        </NeomorphBox>
        ...
        >
          <NeomorphBox width={200} height={50} forceTheme={'light'}>
            <Text style={styles.buttonText}>スピーチ終わった</Text>
          </NeomorphBox>
        </TouchableOpacity>
      </View>
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.questionContainer}>
        ...
        */}
          <NeomorphBox width={320} height={280} forceTheme={'light'}>
            <Text style={styles.passageTitle}>英文パッセージ</Text>
            <Text style={styles.passageText}>{questionNumber}を選んだ場合</Text>
...
const styles = StyleSheet.create({
  ...
  choiceText: {
    fontSize: 20, // Adjust size for readability
    fontWeight: 'bold',
    color: '#4a90e2', // A pleasant blue color
