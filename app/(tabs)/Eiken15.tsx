...
import { sampleQuestions, passageText } from '../../constants/1_5/questions15';
...
const ExamQuestionCard: React.FC = () => {
  ...
  useFocusEffect(
    React.useCallback(() => {
      ...
      playTTS("You have one minute to prepare.befor you start narration");
  ...
  useEffect(() => {
    if (countdown > 0 && showCard) {
      ...
      playTTS("All right, please beginyour narration. Youhave two minutes.");
    }
  }, [countdown, showCard]);
  ...
  if (examFinished) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.header}>準1級評価結果</Text>
        <ScrollView
      ...
      <Text style={styles.passageText}>{passageText}</Text>
        ...
        >
          <NeomorphBox width={200} height={50} forceTheme={'light'}>
            <Text style={styles.buttonText}>The narration has ended</Text>
          </NeomorphBox>
        </TouchableOpacity>
      </View>
    );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.questionContainer}>
        ...
        */}
        {questionNumber === 1 && (
          <NeomorphBox width={320} height={500} forceTheme={'light'}>
            <Text style={styles.passageText}>{passageText}</Text>
            <Image
              source={require('../../assets/images/1_5.jpg')}
              style={styles.passageImage}
